...
const HomePage = () => {
  ...
  return (
    <div className="w-full bg-white relative">
            ...
            <div className="mt-10 flex flex-col items-center lg:items-start gap-6">
              ...
              <div className="flex items-center gap-3">
                <div className="flex -space-x-3">
                  {["/avatars/user1.jpg", "/avatars/user2.png", "/avatars/user3.jpg", "/avatars/user4.jpg", "/avatars/user5.jpg"].map((src, i) => (
                    <img
                      key={i}
                      src={src}
                      alt={`User ${i + 1}`}
                ...
                <div className="flex flex-col">
                  <span className="text-sm font-bold text-slate-900 leading-none">1K+ Happy Customers</span>
      ...
      {/* ================= TRENDING BOOKS ================= */}
      <section className="w-full px-8 py-24 border-t overflow-hidden">
      ...
      {/* ================= CLEAN MINIMAL: UPCOMING BOOK ALERT ================= */}
      <section className="mx-auto max-w-[1500px] px-8 py-10">
        <div className="bg-[#FFF8F0] rounded-[40px] border border-orange-100 shadow-sm overflow-hidden">
          <div className="flex flex-col md:flex-row items-center justify-between min-h-[400px]">
            {/* LEFT SIDE: PREMIUM TEXT ONLY */}
            <div className="w-full md:w-[40%] p-12 lg:p-20 flex flex-col items-center md:items-start text-center md:text-left">
              <h2 className="text-4xl lg:text-5xl font-serif font-bold text-slate-900 leading-tight">
                Coming Soon
              </h2>
              <p className="mt-4 text-lg text-slate-500 font-medium">
                Upcoming additions planned for the book collection.
              </p>
            </div>

            {/* RIGHT SIDE: BALANCED IMAGE */}
            <div className="w-full md:w-[60%] p-10 flex items-center justify-center">
              <div className="relative w-full max-w-[550px] aspect-[16/9] rounded-[30px] overflow-hidden shadow-2xl border-4 border-white">
                <img 
                  src="/banners/upcoming.jpg" 
                  alt="Upcoming" 
      ...
      {/* ================= MODALS ================= */}
      <RequestBookPage open={openRequestModal} onClose={() => setOpenRequestModal(false)} />
        ...
        <div className="fixed inset-0 z-[300] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl p-8 w-full max-w-lg shadow-2xl">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-serif font-bold text-slate-800">🎧 {currentAudio.title}</h2>
            ...
            <div className="bg-slate-50 p-6 rounded-xl mb-6">
              <audio src={currentAudio.audioUrl} controls autoPlay className="w-full" />
            </div>
            <Button className="w-full py-6 rounded-xl" variant="outline" onClick={() => { setOpenAudioPlayer(false); setCurrentAudio(null); }}>Close Player</Button>
          </div>
        </div>
      )}
    </div>
